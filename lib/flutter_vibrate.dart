...
class Vibrate {
  ...
  static Future vibrate({Duration duration = defaultVibrationDuration}) =>
  ...
  static Future vibrateWithPauses(Iterable<Duration> pauses,
      {Duration duration = defaultVibrationDuration}) async {
